# -*- coding: utf-8 -*- Implementation of Wang et al 2017: Automatic Brain Tumor Segmentation using Cascaded
# Anisotropic Convolutional Neural Networks. https://arxiv.org/abs/1709.00382
    ...
    def __get_one_batch(self):
        ...
        for i in range(batch_size):
            ...
            if (self.with_ground_truth):
                ...
                if (self.label_convert_source and self.label_convert_target):
                    label_volumes[0] = convert_label(label_volumes[0], self.label_convert_source,
                                                     self.label_convert_target)
